...
* **署名器**: Nostrアカウントの秘密鍵を持ち、アプリの代わりに*署名を行う*Nostrアプリ
...
アプリは公開鍵の取得やイベントへの署名を行うよう署名器に求めます。
...
2. **署名器**は**アプリ**に`diaconnect`要求を行います。
