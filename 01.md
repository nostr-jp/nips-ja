...
タグ配列の最初の要素をタグの _名前_ または _キー_ と呼び、二番目をタグの _値_ と呼ぶ。したがって、上のイベントでは`e`タグが`"5c83da77af1dec6d7289834998ad7aafbd9e2191396d75ec3cc27f5a77226f36"`に設定されていて、`alt`タグが`"reply"`に設定されている、などと言える。二番目より後の要素には慣用的な呼び方はない。
